    ...
    <main className="h-[34rem] w-full bg-primary rounded-md">
      ...
      <section className="flex justify-evenly items-center">
        <div className="w-[35%]">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="flex flex-col w-[100%]">
            <input
              type="email"
              placeholder="Email"
          ...
          <div className="my-3 py-2 flex justify-center items-center cursor-pointer font-[700] text-[1.15rem]"><p>Forgot Passwod?</p></div>
        </div>
